...
tariff_select = int(input("Enter tariff, 11 or 31: ")) # Get user input selection
if tariff_select == 11: # if, elif compared to an integer
    tariff_rate = TARIFF_11 # if integer = 11 then put CONSTANT TARIFF_11 into variable tariff_rate
